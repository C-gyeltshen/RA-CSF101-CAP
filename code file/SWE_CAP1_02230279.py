...
################################
# REFERENCES
#print("https://www.youtube.com/watch?v=LpZmZs2_BC4")
...
# def read_input():
#     with open('input_9_cap1.txt') as file:
#         print(file.read())
...
def main():
    ...
    for round_info in rounds:
        ...
        # Print opponent's choice and your choice for demonstration purposes
        ...
        print(f"Score for round {rounds_played}:", round_score)
